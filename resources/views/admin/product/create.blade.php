...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="form-w100">
                <div class="card">
                    <div class="card-header">{{ __('Новый товар') }}</div>
                    @if($cats->isNotEmpty())
                        <div class="card-body">
                            <form method="POST" action="{{route('product.store')}}" aria-label="{{__('Create Product') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="price" type="number" class="form-control{{ $errors->has('price_rub') ? ' is-invalid' : '' }}" name="price_rub" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="quantity" type="number" class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" name="quantity" required autofocus>
                    ...
                    @else
                        <div class="row justify-content-center align-items-end">
                            <p>Сначала заполните категории товаров (в БД нет категорий).</p>
